        ...
        <div className="chat_div">
            <div className="chat_out_div">
                <div className="chat_innertitle_div">
                    <div style={{ width: "50%" }}><span className="chat_nick_span">닉네임1</span></div>
                    <div style={{ width: "50%" }}>
                        <span className="chat_option_span">신고</span> <span className="chat_option_span"> | </span> <span className="chat_option_span">후기 남기기 </span>
                    </div>
